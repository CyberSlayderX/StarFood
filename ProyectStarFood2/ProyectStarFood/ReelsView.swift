    ...
    var body: some View{
        ZStack{
            if let  player = reel.player{
                ...
                Image(systemName: isMuted ? "speaker.slah.fill" : "speaker.wave.2.fill")
                    .font (.title)
                    .foregroundColor(.white)
                    .padding()
...
struct ActionButtons: View{
 ...
 let sampleText = "In loremloremimputIn loremloremimputIn loremloremimputIn loremloremimputIn loremloremimputIn loremloremimputIn loremloremimputIn loremloremimputIn loremloremimput"
